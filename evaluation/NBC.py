...
from Adequacy.NC import NeuronCoverage
...
class NeuronBoundsCoverage(CoverageMetrics):
    """
    ...
    def __init__(self, model, train_dataset,  batch_size=None):
